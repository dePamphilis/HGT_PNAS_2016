...
# aegyptiaca genes start with OrAeBC5) group with donor genes from rosids. This is a less strigent approach that requires only one node that strongly support the grouping
...
if (len(sys.argv) != 2 ):
	print "get_orobanchaceae_SO_dup_events.py <newick_trees_dir>"
	exit()
